# -*- coding: utf-8 -*-
# Reconferencia ao vivo em 2026-09-24 ~18:20 UTC (15:20 BRT), rodada seguinte a
# _verify0924b.py. As 6 consultas de setembro/2026 foram refeitas no Jira com
...
# Artifact: a pasta do artifact nao esta montada nesta sessao (somente
# pr03-relatorio-publico); usada a copia local _artifact_src.html, conferida
# identica ao artifact ao vivo em 24/09/2026 13:30 (md5 6a2b6462...).
import json, os, sys
