# -*- coding: utf-8 -*-
# Dados verificados contra o Jira ao vivo em 2026-09-22 ~21:30 UTC (18:30 BRT).
# Delta vs _run0922g: NENHUM. Os 6 conjuntos de 2026-09 conferiram registro a
...
# Consultas feitas com issuetype in ("Epic","Fluxo de trabalho"), conforme o ETQ
# dinamico do artifact (ver alerta no README sobre issuetype=Epic isolado).
# _artifact_src.html conferido contra o artifact ao vivo (md5 6a2b6462... identico).
