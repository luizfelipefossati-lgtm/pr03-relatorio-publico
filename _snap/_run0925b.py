# -*- coding: utf-8 -*-
# Consultas refeitas ao vivo no Jira em 2026-09-25 ~13:30 UTC (10:30 BRT).
# DELTA vs _run0922h / _verify0925a: DOIS epics do EG0274 tiveram o duedate
# reagendado hoje (2026-09-25 ~09:56 BRT) de setembro para outubro:
#   EG0274-58 "Proj. Basico - Projeto de Terraplenagem"  2026-09-17 -> 2026-10-30
#   EG0274-21 "Proj. Basico - Projeto de Pavimentacao"   2026-09-17 -> 2026-10-29
# Efeito: planned_2026-09 cai de 20 para 18; lookahead_2026-09 sobe de 27 para 29.
# Os demais conjuntos de setembro conferiram registro a registro:
#   overdue=2, sent=5, resolved=4, rework=2 (sem alteracao).
# getVisibleJiraProjects: 20 projetos, mesmas chaves de _projects_min.json;
# tipos de nivel Epic = [Epic, Fluxo de trabalho].
# _artifact_src.html conferido contra a copia ao vivo do desktop
# (device_stage_files artifact_ids): md5 6a2b6462a4efbec1890af4494a7f0b74 identico.
import sys, os
...
("EG0274-21","Proj. Básico - Projeto de Pavimentação",N,"new","EG0274","2026-10-29",None,"2026-09-25T09:56:37.062-0300"),
("EG0274-58","Proj. Básico - Projeto de Terraplenagem",N,"new","EG0274","2026-10-30",None,"2026-09-25T09:56:03.350-0300"),
