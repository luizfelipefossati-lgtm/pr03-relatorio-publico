# -*- coding: utf-8 -*-
# Dados verificados contra o Jira ao vivo em 2026-09-22 ~20:30 UTC (17:30 BRT).
# Delta vs _run0922f: NENHUM. Os 6 conjuntos de 2026-09 conferiram registro a
# registro (key/summary/status/duedate/resolutiondate/updated):
#   planned=20, overdue=2, sent=5, resolved=4, rework=2, lookahead=27.
# getVisibleJiraProjects: 20 projetos, mesmo conjunto de chaves/nomes de
