# -*- coding: utf-8 -*-
# Dados re-verificados contra o Jira ao vivo em 2026-09-21 ~17:29 UTC (14:29 BRT).
# Conteudo identico ao _run0921d.py (nenhuma mudanca no Jira); ordem conforme resposta do Jira.
import sys, os
