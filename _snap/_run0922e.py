# -*- coding: utf-8 -*-
# Dados verificados contra o Jira ao vivo em 2026-09-22 ~18:30 UTC (15:30 BRT).
# Delta vs _run0922d: NENHUM. Os 6 conjuntos de 2026-09 conferiram registro a
# registro (key/summary/status/duedate/resolutiondate/updated):
#   planned=20, overdue=2, sent=5, resolved=4, rework=2, lookahead=27.
# getVisibleJiraProjects: 20 projetos, mesmo conjunto de chaves de
# _projects_min.json (CREA..PE); tipos de nivel Epic = [Epic, Fluxo de trabalho].
# ATENCAO: as consultas desta geracao foram refeitas com
#   issuetype in ("Epic","Fluxo de trabalho")
# conforme o ETQ dinamico do artifact. Uma rodada exploratoria com
# issuetype=Epic devolveu 14 planned / 1 overdue (faltando EG0286-* e EG0285-19),
# confirmando o alerta ja registrado no README.
