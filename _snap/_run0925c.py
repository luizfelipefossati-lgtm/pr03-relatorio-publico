# -*- coding: utf-8 -*-
# Consultas refeitas ao vivo no Jira em 2026-09-25 ~16:30 UTC (13:30 BRT).
# DELTA vs _run0925b (13:30 UTC / 10:30 BRT): NENHUM.
#   planned=18, overdue=2, sent=5, resolved=4, rework=2, lookahead=29 - identicos
#   registro a registro (chaves, status, duedate, resolutiondate, updated).
# getVisibleJiraProjects: 20 projetos, isLast=true; md5 do _projects_min.json
# normalizado confere com a resposta ao vivo (4fd525a3c9d169f41a9533fd26b78178).
...
K="2026-09"
write('planned_'+K, planned)
write('overdue_'+K, overdue)
write('sent_'+K, sent)
write('resolved_'+K, resolved)
write('rework_'+K, rework)
write('lookahead_'+K, lookahead)
