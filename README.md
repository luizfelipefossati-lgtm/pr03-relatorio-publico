...
- **Última geração:** 03/08/2026 13:17 (America/Sao_Paulo)
- **Timestamp ISO:** 2026-08-03T16:17:19Z
- **Mês corrente (capturado nesta geração):** Agosto/2026 — 16 EPICs previstos, 3 em atraso acumulado, 28 no lookahead (set–out), 0 enviados/resolvidos/retrabalho no mês até a captura
- **Mês anterior (congelado nesta geração):** Julho/2026 — 10 EPICs previstos, 1 em atraso, 11 enviados/resolvidos (4 com retrabalho), 28 no lookahead (ago–set)
