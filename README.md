...
Snapshot estático do dashboard **Estudos e Projetos — Relatório de Indicadores** (Engeplus Engenharia), gerado a partir do Live Artifact `pr03-relatorio-indicadores-epics`.
...
Publicação automática: o Windows Task Scheduler (`PR03-Auto-Push-GitHub`) faz commit e push a cada 30 min; o deploy no Vercel ocorre logo após o push.
