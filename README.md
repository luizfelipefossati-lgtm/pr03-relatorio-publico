...
- **Última atualização:** 15/07/2026 12:07 (horário local da geração)
- **Timestamp ISO:** 2026-07-15T12:07:24-03:00
...
A página não consulta o Jira ao vivo — todos os dados estão embutidos em `window.__SNAPSHOT__` e `window.cowork.callMcpTool` é sobrescrito para devolvê-los offline. Consultas congeladas nesta geração: 1× `getVisibleJiraProjects` + 8 JQL do mês corrente/acumulado (Julho: planned 15, overdue 4, lookahead 6, sent 2, resolved 5, rework 2; acumulado planned Fev 1, Mar 5).
