...
- **Última geração:** 06/08/2026 17:19 (America/Sao_Paulo)
- **Timestamp ISO:** 2026-08-06T17:19:00-03:00
...
- Julho e Agosto/2026 são injetados em `__HISTORY__` como períodos fechados; um override de `callMcpTool` responde à lista de 18 projetos, aos previstos de Março/2026 (acumulado) e serve de rede de segurança para qualquer consulta JQL, devolvendo os dados pré-buscados conforme o padrão da consulta. Nenhuma consulta ao Jira ao vivo é feita.

## Indicadores (no momento da geração)

- **Julho/2026:** 10 previstos, OTD 80% · 1 em atraso · 11 enviados (4 retrabalho).
- **Agosto/2026:** 16 previstos, OTD 0% (mês em curso) · 3 em atraso acumulado · 28 próximos (ago–set).
