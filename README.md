...
**Última atualização:** 10/08/2026 18:17 (2026-08-10T18:17:53-03:00)

Os dados são congelados no momento da geração — a página publicada não consulta o Jira ao vivo. Conteúdo do snapshot:

- **Aba mensal Agosto/2026 (mês corrente):** dados reais congelados neste snapshot — 16 EPICs previstos, 3 em atraso acumulado, 28 no look-ahead (Set–Out/2026); nenhum envio, entrega ou retrabalho registrado no mês até a geração.
- **Aba mensal Julho/2026 (mês anterior):** congelado no histórico interno deste snapshot com dados reais — 10 EPICs previstos, 11 enviados/entregues (dos quais 4 com retrabalho), 1 em atraso acumulado. Exibe os dados diretamente na aba (não há consulta ao vivo).
